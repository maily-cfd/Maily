...
const FROM_ADDRESS = 'Maily <onboarding@maily.cfd>';
// maily.cfd has no MX record — a reply to the FROM address would bounce.
          ...
          <tr>
            <td style="padding-top:48px; text-align:center;">
              <p style="font-size:12px; color:#999999; line-height:1.6; font-family:'Satoshi', sans-serif;">
                ...
                <a href="https://maily.cfd" class="footer-link">maily.cfd</a>
                &nbsp;·&nbsp;
...
function buildMonthlyEmail(name) {
  ...
  const content = `
    ...
    <div style="background:#000000; border-radius:20px; padding:32px;">
      ...
      <a href="https://maily.cfd/home-feed" style="display:inline-block; padding:12px 32px; background:#ffffff; color:#000000; font-weight:600; font-size:14px; border-radius:12px;">
        Open maily.cfd
      </a>
    </div>
...
function buildProEmail(name) {
  ...
  const content = `
    ...
    <a href="https://maily.cfd/home-feed" style="display:block; text-align:center; padding:18px; background:#000000; color:#ffffff; font-weight:700; font-size:16px; border-radius:16px;">
...
/* ─────────────── LANDING HOOK — opt-in capture on maily.cfd ───────────────
 *
...
export function buildLandingHookEmail() {
  ...
  return EmailUI.shell({
    ...
    footerNote: 'You left your email on maily.cfd — that is the only reason this reached you.',
  });
}
