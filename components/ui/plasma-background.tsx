...
export function PlasmaBackground() {
  ...
  useEffect(() => {
    ...
    gl.uniform4f(locs.u_shape, 1.50, 0.48, 0.50, 0.00);
    gl.uniform4f(locs.u_surface, 2.40, 0.92, -0.50, 1.00);
    gl.uniform4f(locs.u_finish, 3.04, 0.61, 0.016, 0.18);
    gl.uniform4f(locs.u_transform, 7.0, 0.00, 0.32, 0.0);
    gl.uniform4f(locs.u_space, 0.0, 0.0, 0.0, 0.0);
    gl.uniform4f(locs.u_cursor, 0.0, 2.0, 0.65, 0.30); // presence = 0
    ...
    const render = () => {
      ...
      gl.uniform4f(locs.u_scene, canvas.width, canvas.height, elapsed * 0.59, 4.0);
